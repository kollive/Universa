...
function* updateWPlanTable(userData) {
    try {
        /*
          yield put({
            type: tsplanTypes.ITEMS,
            items: []
          });

          yield put({
            type: tsplanTypes.SELECTED_ROWID,
            rowID: -1
          });
          */
...
function* exportToExcel(payload) {
    ...
    try {
        ...
        //yield put({ type: tsplanTypes.LOGIN_REQUEST, isLoading: false })
        ...
        /*
          ...
          */
        debugger;
        yield put({ type: tsplanTypes.MESSAGE, message: e });
    } finally {
        debugger;
        if (yield cancelled())
            yield put({ type: tsplanTypes.MESSAGE, message: "Task Cancelled" });
    }
}

function* getTSPlan(userData) {
    debugger;
    try {
        //yield call(delay, 5000)
        //yield put({ type: tsplanTypes.LOGIN_REQUEST, isLoading: false })
        ...
        */
        ...
        let resultObj = yield call(attribApi.getTSPlan, userData);
        ...
        debugger;
        yield put({ type: tsplanTypes.MESSAGE, message: { val: -1, msg: e } });
    } finally {
        debugger;
        if (yield cancelled())
            yield put({ type: tsplanTypes.MESSAGE, message: { val: -1, msg: "Task Cancelled" } });
    }
}
...
export function* handleRequest(action) {
    ...
    try {
        switch (action.type) {
            case tsplanTypes.FETCH_TABLE_REQUEST: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
                const fetchTask = yield fork(getTSPlan, action.payload);
                debugger;
                break;
            }

            case tsplanTypes.EXCEL_REQUEST: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
            ...
            case tsplanTypes.INSERT_REQUEST: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
            ...
            case tsplanTypes.INSERTHOUR_REQUEST: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
            ...
            case tsplanTypes.UPDATE_REQUEST: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
            ...
            case tsplanTypes.MAKE_ROW_EDITABLE: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
                yield put({
                    type: tsplanTypes.SELECTED_ROWID,
            ...
            case tsplanTypes.DELETE_REQUEST: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
            ...
            case tsplanTypes.CANCEL_REQUEST: {
                //yield all([put({ type: "LOGIN_STATUS", message: '' }), put({ type: "ITEMS_IS_LOADING", isLoading: true })])
                debugger;
        ...
        yield put({ type: tsplanTypes.LOGIN_FAILURE, error: e });
    }
}
